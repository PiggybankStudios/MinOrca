...
#define SCRATCH_ARENAS_PAGE_SIZE   Megabytes(8)
#define SCRATCH_ARENAS_MAX_MARKS   32

#define DEBUG_OUTPUT_ENABLED     0
#define REGULAR_OUTPUT_ENABLED   0
#define INFO_OUTPUT_ENABLED      0
#define NOTIFY_OUTPUT_ENABLED    0
#define OTHER_OUTPUT_ENABLED     0
#define WARNING_OUTPUT_ENABLED   0
#define ERROR_OUTPUT_ENABLED     0
